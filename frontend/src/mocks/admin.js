...
export const users = [
  { id: 1, username: 'alice', roleId: 'SYS_ADMIN', departmentId: 'DPT-001' },
  { id: 2, username: 'bob', roleId: 'EQUIP_MANAGER', departmentId: 'DPT-002' },
  { id: 3, username: 'charlie', roleId: 'DEPT_USER', departmentId: 'DPT-006' },
  { id: 4, username: 'david', roleId: 'DEPT_USER', departmentId: 'DPT-004' },
  { id: 5, username: 'eve', roleId: 'PROC_STAFF', departmentId: 'DPT-003' },
  { id: 6, username: 'frank', roleId: 'DEPT_USER', departmentId: 'DPT-005' },
  { id: 7, username: 'grace', roleId: 'DEPT_USER', departmentId: 'DPT-007' },
  { id: 8, username: 'henry', roleId: 'DEPT_USER', departmentId: 'DPT-001' },
  { id: 9, username: 'irene', roleId: 'EQUIP_MANAGER', departmentId: 'DPT-002' },
  { id: 10, username: 'jack', roleId: 'DEPT_USER', departmentId: 'DPT-003' },
  { id: 11, username: 'kate', roleId: 'DEPT_USER', departmentId: 'DPT-004' },
  { id: 12, username: 'leo', roleId: 'DEPT_USER', departmentId: 'DPT-006' },
  { id: 13, username: 'mike', roleId: 'DEPT_USER', departmentId: 'DPT-005' },
  { id: 14, username: 'nina', roleId: 'DEPT_USER', departmentId: 'DPT-007' },
  { id: 15, username: 'oliver', roleId: 'DEPT_USER', departmentId: 'DPT-001' },
  { id: 16, username: 'peggy', roleId: 'DEPT_USER', departmentId: 'DPT-002' },
  { id: 17, username: 'quentin', roleId: 'DEPT_USER', departmentId: 'DPT-003' },
  { id: 18, username: 'rachel', roleId: 'DEPT_USER', departmentId: 'DPT-004' },
  { id: 19, username: 'steve', roleId: 'DEPT_USER', departmentId: 'DPT-005' },
  { id: 20, username: 'tina', roleId: 'DEPT_USER', departmentId: 'DPT-006' },
]
